...
# Programs
CC     ?= ${IOTIVITY_TOOLCHAIN_DIR}/bin/${IOTIVITY_TOOLCHAIN_PREFIX}-gcc
AR     ?= ${IOTIVITY_TOOLCHAIN_DIR}/bin/${IOTIVITY_TOOLCHAIN_PREFIX}-ar
RANLIB ?= ${IOTIVITY_TOOLCHAIN_DIR}/bin/${IOTIVITY_TOOLCHAIN_PREFIX}-ranlib
MKDIR  ?= mkdir -p
RM     ?= rm -f

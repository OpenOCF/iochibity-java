...
public class AndroidClient
{
	...
	Service.config(//null,
		       "/tmp/oocf_client.log", // logfile_fname
		       "/client_config.cbor"
		       );
	// Service.init(null);	// stdout
    }
	...
	while(again) {
		...
		try {
		    // latch: wait for discovery to complete (unecessary?)
	...
	OCF.Init(OCF.CLIENT_SERVER); // , "src/main/resources/ocftestclient_config.cbor");

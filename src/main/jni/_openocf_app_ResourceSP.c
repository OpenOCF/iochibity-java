 ...
 * `c_resource_sp_OCEntityHandlerRequest_to_StimulusIn`
			      ...
			      void* j_ResourceSP)
{
    ...
    */
    ...
    jobject j_InboundStimulus = (*env)->NewObject(env, K_INBOUND_STIMULUS, MID_INBOUND_STIMULUS_CTOR);
    if (j_InboundStimulus == NULL) {
        THROW_JNI_EXCEPTION("ERROR:  ctor InboundStimulus() failed\n");
    }

    /* jobject j_StimulusIn = NULL; */
    /* j_StimulusIn = c_resource_sp_OCEntityHandlerRequest_to_StimulusIn(env, */
    /* 								      c_OCEntityHandlerRequest, */
    /* 								      watch_flag); */

    /* fflush(NULL); */
    /* if (j_StimulusIn == NULL) { */
    /*     THROW_JNI_EXCEPTION("ERROR:  OCEntityHandlerRequest_to_StimulusIn failed\n"); */
    /* 	return OC_EH_INTERNAL_SERVER_ERROR; */
    /* } */
	...
	THROW_STACK_EXCEPTION(op_result, "InboundStimulus.react");

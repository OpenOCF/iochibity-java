/**
 * @file openocf_engine_OCFServerSP.c
...
#include "openocf.h"
#include "openocf_engine_OCFServerSP.h"
...
JNIEXPORT void JNICALL Java_openocf_engine_OCFServerSP_exhibit(JNIEnv *env, jclass kilass, jobject this_SP)
{
    ...
    /* 	(*env)->GetLongField(env, j_StimulusIn, FID_INBOUND_STIMULUS_LOCAL_HANDLE); */
    /* if (j_handle == NULL) { */
 ...
 */
//JNIEXPORT jobject JNICALL Java_openocf_engine_OCFServerSP_registerServiceProvider__Lorg_iochibity_ServiceProvider_2
JNIEXPORT jobject JNICALL
Java_openocf_engine_OCFServerSP_registerResourceSP(JNIEnv * env, jclass klass, jobject j_ResourceSP)
{
    OC_UNUSED(klass);

/**
 * @file openocf_signals_Behavior.c
...
#include "openocf_signals_Behavior.h"
#include "jni_init.h"
...
{
    jclass klass;
    klass = (*env)->FindClass(env, "openocf/Message");
    JNI_ASSERT_NULL(klass, "FindClass failed for openocf/Message\n", -1);

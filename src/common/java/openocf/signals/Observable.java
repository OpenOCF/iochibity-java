...
// Wraps common elements of InboundStimulus, InboundResponse: OCDevAddr, VendorSpecificHeaderOptions; Uri?

// Server side: InboundStimulus, wrapper on:
...
public class Observable extends Behavior
{
    ...
    native public Endpoint getRemoteEP();

    // put this in ObservedBehavior:
    // the payload from the request PDU.
    native public long getObservationRecordHandle();

    native public ObservationList<ObservationRecord> getObservationRecords();
